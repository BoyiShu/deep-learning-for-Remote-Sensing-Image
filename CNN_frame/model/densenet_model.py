...
class DenseNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.features = nn.Sequential(OrderedDict([
            ("conv0", nn.Conv2d(in_chans, num_init_features, kernel_size=7, stride=2, padding=24, bias=False)),
...
def densenet121(in_channels=4, num_classes=8, **kwargs: Any) -> DenseNet:
    # Top-1 error: 25.35%
...
def densenet169(in_channels=4, num_classes=8, **kwargs: Any) -> DenseNet:
    # Top-1 error: 24.00%
...
def densenet201(in_channels=4, num_classes=8, **kwargs: Any) -> DenseNet:
    # Top-1 error: 22.80%
...
def densenet161(in_channels=4, num_classes=8,**kwargs: Any) -> DenseNet:
    # Top-1 error: 22.35%
