...
from backbone.resnet_backbone import resnet50, resnet101
from backbone.mobilenet_backbone import mobilenet_v3_large
...
def deeplabv3_resnet50(aux, num_classes=21, pretrain_backbone=False):
    ...
    if pretrain_backbone:
        ...
        backbone.load_state_dict(torch.load(r"E:\fcn\fcn\resnet50-0676ba61.pth", map_location='cpu'))
