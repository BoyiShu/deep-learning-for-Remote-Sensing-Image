...
# 加载PNG图像并转换为NumPy数组
predicted_image = np.array(Image.open(r"D:\pyhsj3\9_labels_sub_8_3.tif"))
label_image = np.array(Image.open(r"D:\pyhsj3\9_labels_sub_8_3.tif"))
...
for file_name in os.listdir(folder_path):
    if file_name.endswith(".npy"):
        ...
        # 写入行标题
        sheet['A1'] = "Metrics"
        metrics = ["Kappa", "OA", "UA", "PA", "F1 Score","IoU"]
        ...
        for class_idx in range(num_classes):
            ...
            precision, recall, f1_score,iou = calculate_precision_recall_f1(matrix)
